...
if(TRUE) {
  ...
  if (length(args)==0) {
      ...
      outdir = paste0("./RETCHER_out_",my.pt,'_1')
...
# path = 'C:/Users/Owner/OneDrive - University of Pittsburgh/Sunny_work/Projects/TIIL-017-RoseProj/results/exome/PDO_sm61/pyclone-vi_altDP3/Pt/'
